...
//    $('.CreateCar').load('/MyCar/Car/Create .CreateForm', function () {
//        function submiEvent() {
//            $(document).off('submit', '.CreateForm').one('submit', '.CreateForm', function (e) {
//                e.preventDefault(); // 防止默認提交行為
//                $.ajax({
...
//                            $('.CarTable').DataTable().ajax.reload(null, false); // 刷新特定部分
//                        } else {
//                            // 如果失敗，動態替換SweetAlert，顯示錯誤
//                            Swal.fire({
//                                icon: "error",
//                                title: "Oops...",
//                                text: response.errors ? response.errors.join(", ") : response.message,
//                            });
//                            submiEvent();
//                        }
//                    }
...
//    var id = $(this).data('id'); // 獲取該筆資料的 ID
//    $('.EditCar').load(`/MyCar/Car/Edit/${id} #EditForm`, function () {
...
//            $.ajax({
//                url: `/MyCar/Car/Delete/${id}`,  // 刪除請求的 URL
//                type: 'POST',
//                data: {
